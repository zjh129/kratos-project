...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	r := s.Route("/")
	r.POST("/admin/user/login", _User_UserLogin0_HTTP_Handler(srv))
	r.POST("/admin/user/logout", _User_UserLogout0_HTTP_Handler(srv))
	r.POST("/admin/user/user", _User_CreateUser0_HTTP_Handler(srv))
	r.PUT("/admin/user/user", _User_UpdateUser0_HTTP_Handler(srv))
	r.DELETE("/admin/user/user/{id}", _User_DeleteUser0_HTTP_Handler(srv))
	r.GET("/admin/user/users", _User_ListUser0_HTTP_Handler(srv))
	r.GET("/admin/user/user/{id}", _User_FindUser0_HTTP_Handler(srv))
}
